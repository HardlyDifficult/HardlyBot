...
namespace Hardly.Games.Tests {
    ...
    public class PokerPlayerHandEvaluatorTests {
        ...
        public void PokerPlayerHandEvaluatorTestStraightFlush() {
            var tableCards = new PlayingCardList(new[] {
                c2c, cjc, c9c, c3d, c8c
            });
            var h1 = new PokerPlayerHandEvaluator(new PlayingCardList(new[] {
                c0c, c7c,
            }), tableCards);
            var h2 = new PokerPlayerHandEvaluator(new PlayingCardList(new[] {
                c0c, c6c,
            }), tableCards);
            var h3 = new PokerPlayerHandEvaluator(new PlayingCardList(new[] {
                c0d, c6d,
            }), tableCards);
