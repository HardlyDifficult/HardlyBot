...
namespace Hardly.Library.Twitch {
    public class SqlTwitchChannelPointScale : SqlRow, TwitchChannelPointScale {
        ...
        public SqlTwitchChannelPointScale(TwitchChannel channel, ulong unitValue, string unitNameSingular = null, string unitNamePlural = null) : base(new object[] {
